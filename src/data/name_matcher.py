...
class PlayerNameMatcher:
    ...
    def create_name_mapping(self,
        ...
        logger.info(f"Name matching complete: {matched_count}/{total_count} players matched ({matched_count*100/total_count:.1f}%)")
...
def test_matcher():
    ...
    for str1, str2 in pairs:
        score = matcher.calculate_similarity(
            matcher.normalize_name(str1),
            matcher.normalize_name(str2)
        )
